/**
 * صفحة تسجيل الدخول وإنشاء الحساب لمنصة Ntfly
 * تدعم Mock Mode بدون Firebase
 */
...
import { signInWithEmail, signUpWithEmail } from '@/firebase/firebase.auth';
import { t } from '@/i18n';
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-muted rounded-lg text-xs text-muted-foreground text-center">
            📦 وضع Mock نشط - أدخل أي بريد وكلمة مرور للتجربة
          </div>
        </CardContent>
      </Card>
    </div>
